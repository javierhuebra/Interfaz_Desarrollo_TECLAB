...
const retornarTablaHTML = () => {
    ...
    let tabla = ''
    carritoFrutas.map(producto => ( //Uso map porque ya use For each en los anteriores
...
carritoFrutas.length > 0 && retornarTablaHTML() //Compruebo si hay algo en carritoFrutas
